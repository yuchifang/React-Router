...
const HomePage = () => {
  ...
  const getData = async () => {
    const a = await new Promise((resolve) => setTimeout(resolve, Math.random() * 1000 + 10000));
  ...
  return (
    <>
      ...
      {webStatus === "error" && <Alert description="模擬錯誤 請重新整理" message="Error" type="error" showIcon />}
    </>
  );
};
